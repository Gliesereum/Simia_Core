package com.simia.share.common.model.dto.karma.bonus;
...
public class BonusScoreDto extends DefaultDto {
    ...
    private List<BonusScoreHistoryDto> history = new ArrayList<>();
}
