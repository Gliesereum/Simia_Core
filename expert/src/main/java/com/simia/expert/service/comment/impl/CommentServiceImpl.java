...
@Service
public class CommentServiceImpl extends AuditableServiceImpl<CommentDto, CommentEntity> implements CommentService {
	...
	public List<CommentDto> findByObjectId(UUID objectId) {
		...
		if (objectId != null) {
			List<CommentEntity> entities = commentRepository.findByObjectIdOrderByCreateDateDesc(objectId);
